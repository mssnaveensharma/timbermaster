...
<body bottomMargin=0 leftMargin=0 topMargin=0 rightMargin=0 marginheight=0 marginwidth=0>
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr bgcolor="#FFFFFF" vAlign=bottom>
			...
			<td width="152" nowrap align="left"><img src="./images/topBar/Fondo_menu2.gif" width="152" height="30" border=0></td>
			<td width="60%" nowrap align="left"><img src="./images/topBar/imagen1_svp1.jpg" border=0></td>
			<td width="40%" nowrap align="right"><img src="./images/topBar/logo_svp.gif" border=0></td>			  
		</tr>
	</table>
</body>
</html>